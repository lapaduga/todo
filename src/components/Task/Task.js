...
function Task({props, onDeleted, onComplete, onEdit, onEnter, onChange, addSuffix, includeSeconds}) {
  return (
      ...
      <div className="view">
        ...
        <label>
          <span className="description">{props.value}</span>
					<span className="created">created {formatDistanceToNow(new Date(props.timestamp), { addSuffix: addSuffix, includeSeconds: includeSeconds })}</span>
        </label>
